...
const assistantCopy = {
  en: {
    ...
    systemPrompt(defaults: BusinessDefaults) {
      return [
        'You are a CRM assistant for a Dominican Republic business application.',
        ...
        'Extract structured arguments conservatively. Never invent IDs, dates, taxes, emails, or prices.',
  ...
  es: {
    ...
    systemPrompt(defaults: BusinessDefaults) {
      return [
        'Eres un asistente de CRM para una aplicación de negocio en República Dominicana.',
        ...
        'Extrae argumentos estructurados con cautela. Nunca inventes IDs, fechas, impuestos, correos ni precios.',
...
export function getAssistantCopy(locale: CopyLocale) {
